...
public class FpsakTjenesteStub implements FpsakTjeneste {
    ...
    private final Map<Saksnummer, List<DokumentTypeHistoriske>> manglendeVedlegg = new ConcurrentHashMap<>();
    ...
    public FpsakTjenesteStub leggTilManglendeVedlegg(Saksnummer saksnummer, List<DokumentTypeHistoriske> vedlegg) {
