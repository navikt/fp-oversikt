...
class SakFP0Test {
    ...
    void verifiser_at_gjeldende_vedtak_er_det_med_senest_vedtakstidspunkt() {
        ...
        var gjeldendeVedtak = new FpVedtak(LocalDateTime.now(), uttaksperioderGjeldendeVedtak, Dekningsgrad.ÅTTI, null, null);
        var tidligereVedtak = new FpVedtak(LocalDateTime.now().minusYears(1), List.of(uttaksperiode(now(), now().plusMonths(1), innvilget(ZERO)),
            uttaksperiode(now().plusMonths(1), now().plusMonths(2), innvilget(ZERO))), Dekningsgrad.HUNDRE, null, null);
    ...
    void sjekk_at_mapping_av_vedtak_til_dto_fungere_happy_case() {
        ...
        var vedtak = new FpVedtak(LocalDateTime.now(), uttaksperioder, Dekningsgrad.HUNDRE, null, null);
    ...
    void sjekk_at_mapping_av_vedtak_til_dto_ikke_kaster_exception_når_uttak_er_null() {
        var vedtak = new FpVedtak(LocalDateTime.now(), null, Dekningsgrad.HUNDRE, null, null);
    ...
    void kan_søke_om_endring_hvis_periode_innvilget() {
        var vedtak = new FpVedtak(LocalDateTime.now().minusYears(1), List.of(
            ...
            uttaksperiode(now().plusMonths(1), now().plusMonths(2), avslått())), Dekningsgrad.HUNDRE, null, null);
