...
import no.nav.foreldrepenger.oversikt.uttaksplan.FellesUttaksplanDto.Aktivitet;
import no.nav.foreldrepenger.oversikt.uttaksplan.FellesUttaksplanDto.Arbeidsgiver;
import no.nav.foreldrepenger.oversikt.uttaksplan.FellesUttaksplanDto.Arbeidstidprosent;
import no.nav.foreldrepenger.oversikt.uttaksplan.FellesUttaksplanDto.Gradering;
import no.nav.foreldrepenger.oversikt.uttaksplan.FellesUttaksplanDto.Rolle;
