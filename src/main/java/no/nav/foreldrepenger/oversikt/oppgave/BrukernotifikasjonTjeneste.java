...
import no.nav.tms.brukernotifikasjon.schemas.builders.BeskjedInputBuilder;
import no.nav.tms.brukernotifikasjon.schemas.builders.DoneInputBuilder;
import no.nav.tms.brukernotifikasjon.schemas.builders.NokkelInputBuilder;
import no.nav.tms.brukernotifikasjon.schemas.builders.OppgaveInputBuilder;
