...
public class TilgangPersondataKlient implements TilgangPersondata {
    ...
    @Inject
    public TilgangPersondataKlient(@KonfigVerdi(value = "pdl.pip.endpoint.url", defaultVerdi = "https://pdl-pip-api.prod-fss-pub.nais.io/api/v1/person") String pdlPipUrl,
    ...
    public TilgangPersondataDto hentTilgangPersondata(String ident) {
        var builder = HttpRequest.newBuilder(personURI)
            .header(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON) // Bruk APPLICATION_JSON ?
