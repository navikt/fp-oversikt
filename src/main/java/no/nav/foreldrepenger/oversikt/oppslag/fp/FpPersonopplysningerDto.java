...
record FpPersonopplysningerDto(@NotNull Fødselsnummer fnr, @NotNull LocalDate fødselsdato, @NotNull Kjønn kjønn, @NotNull Navn navn, @NotNull boolean erGift,
                               @NotNull List<FpBarnDto> barn, @NotNull List<EksternArbeidsforholdDto> arbeidsforhold,
                               @NotNull List<EksternArbeidsforholdDto> frilansoppdrag, @NotNull List<SelvstendigNæringDto> selvstendigNæring) {

    record FpBarnDto(@NotNull Fødselsnummer fnr, @NotNull LocalDate fødselsdato, LocalDate dødsdato, Navn navn, @NotNull Kjønn kjønn,
