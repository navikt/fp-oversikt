...
public class DBManglendeVedleggRepository implements ManglendeVedleggRepository {
    ...
    @Override
    public void lagreManglendeVedleggPåSak(Saksnummer saksnummer, List<DokumentTypeHistoriske> manglendeVedlegg) {
    ...
    @Override
    public List<DokumentTypeHistoriske> hentFor(Saksnummer saksnummer) {
